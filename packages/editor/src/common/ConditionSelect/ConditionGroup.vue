<template>
  <div class="conditionSelect" :class="result.type">
    ...
    <el-button type="primary" @click="onAddItem" size="default" :disabled="!result.type || result.type == 'data'">增加条件</el-button>
    <el-button type="danger" @click="onDeleteItem" size="default">删除</el-button>
    <el-button type="primary" v-if="result.type == 'data'" @click="onEditData" size="default">编辑</el-button>
    <Transition>
